...
class _SignupScreenState extends State<SignupScreen> {
  ...
  if (userCredential != null) {
    final user = userCredential; // Accessing the user property directly
    log("User Created Successfully");
    await _auth.saveUserToFirestore(user.uid, _name.text, _email.text); // Pass UID to save user to Firestore
    goToHome(context);
  }
}
}